...
module Cisco
  describe Host do
    ...
    describe '#environment_string' do
      ...
      it 'starts with `env` for cisco_ios_xr' do
      ...
      it 'starts with `export` for cisco_nexus' do
        @platform = 'cisco_nexus-7-x86_64'
    ...
    describe '#validate_setup' do
      ...
      context 'on the cisco_nexus platform' do
        before :each do
          @platform = 'cisco_nexus-7-x86_64'
        end
      ...
      context 'on the cisco_ios_xr platform' do
        before :each do
          @platform = 'cisco_ios_xr-x86_64'
        end
