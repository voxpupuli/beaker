...
($BIN/puppet resource cron crontest user=${TMPUSER} command=/bin/true ensure=present hour='0-6' | grep "defined 'hour' as '0-6'") && (crontab -l -u ${TMPUSER} | grep '\* 0-6 \* \* \* /bin/true')
