...
step "#do_scp_to : can copy a directory to the host"
current_dir = File.dirname(__FILE__)
module_fixture = File.join(current_dir, "../../fixtures/module")
hosts.each do |host|
  logger.debug("can copy a module over")
...
step "#do_scp_to with :ignore : can copy a dir to the host, excluding ignored patterns"
current_dir = File.dirname(__FILE__)
