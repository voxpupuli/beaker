module Beaker
  module Runner
    module Native
      # This module includes helpers for setting the state of a test case.
      ...
      module Outcomes
        ...
        def fail_test msg = nil
          ...
          raise( ::Beaker::DSL::FailTest, message )
        end
        ...
        def pass_test msg = nil
          ...
          raise( ::Beaker::DSL::PassTest, message )
        end
        ...
        def pending_test msg = nil
          ...
          raise( ::Beaker::DSL::PendingTest, message )
        end
        ...
        def skip_test msg = nil
          ...
          raise( ::Beaker::DSL::SkipTest, message )
        end
