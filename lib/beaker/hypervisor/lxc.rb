  ...
  class Lxc < Beaker::Hypervisor
    ...
    def initialize(hosts, options)
      begin
        ...
        raise e.exception('Unable to load lxc, please make sure you have the required system libraries installed and then install beaker with the optional gem_group "hypervisor-lxc" enabled!') if e.message =~ /lxc/
        raise
      end
