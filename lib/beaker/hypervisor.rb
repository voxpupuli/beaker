  ...
  class Hypervisor
    ...
    def self.create(type, hosts_to_provision, options)
      ...
      hyper_class = case type
        ...
        when /^vagrant_openstack$/
          Beaker::VagrantOpenstack
        when /^google$/
...
[ 'vsphere_helper', 'vagrant', 'vagrant_virtualbox', 'vagrant_libvirt', 'vagrant_fusion', 'vagrant_openstack', 'vagrant_workstation', 'fusion', 'aws_sdk', 'vsphere', 'vcloud', 'vcloud_pooled', 'aixer', 'solaris', 'docker', 'google_compute', 'openstack' ].each do |lib|
